 ...
 * <ul>
 * <li>Berço só é permitido em quartos do tipo DUPLO.</li>
...
public final class BercoRules {
    ...
    public static int capacidadeDuplo(boolean temBerco) {
        return temBerco
                ? CAPACIDADE_DUPLO_COM_BERCO
                : CAPACIDADE_DUPLO_SEM_BERCO;
    }
    ...
    public static BigDecimal calcularTaxa(
            TipoQuarto tipo,
            boolean temBerco,
            BigDecimal valorBerco) {
