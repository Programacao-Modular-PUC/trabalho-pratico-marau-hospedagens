...
export default function ReciboModal({ aluguelId, onClose }: Props) {
    ...
    return (
        ...
        >
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-4 overflow-hidden max-h-[90vh] overflow-y-auto">
                ...
                {carregando ? (
                    <p className="text-sm text-gray-400 px-6 py-10 text-center">Carregando recibo...</p>
                ) : erro || !recibo ? (
                    <div className="px-6 py-10 flex flex-col items-center gap-4">
                        <p className="text-sm text-gray-500">{erro ?? "Recibo não encontrado."}</p>
                        <button
                            onClick={onClose}
                    ...
                    <>
                        ...
                        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                            <h2 className="text-lg font-bold" style={{ color: BRAND }}>Recibo de Hospedagem</h2>
                            <div className="flex items-center gap-2">
                                <button
                                    className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border-2 transition-colors cursor-pointer"
                                ...
                                >
                                    <IconEmail /> {enviandoEmail ? "Enviando..." : emailEnviado ? "Enviado!" : "Enviar"}
                                </button>
                                <button
                                    onClick={onClose}
                                    className="text-gray-400 hover:text-gray-600 cursor-pointer transition-colors ml-2"
                                >
                        ...
                        <div className="px-6 py-6">
                            ...
                            {/* Card recibo */}
                            <div id="recibo-print" className="rounded-2xl overflow-hidden border border-gray-100">
